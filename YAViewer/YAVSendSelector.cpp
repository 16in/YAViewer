...
{
	{ (DWORD)SST_CLIPBOARD,								L"クリップボード" },
	{ (DWORD)SST_FACE_EDIT,								L"(´д｀) Edit" },
	{ (DWORD)(SST_FACE_EDIT | SST_TEXTBOX_FLAG),		L"(´д｀) ﾃｷｽﾄﾎﾞｯｸｽ" },
	{ (DWORD)SST_ORINRIN_EDITOR,						L"Orinrin Editor" },
	{ (DWORD)(SST_ORINRIN_EDITOR | SST_TEXTBOX_FLAG),	L"Orinrin ﾚｲﾔﾎﾞｯｸｽ" },
